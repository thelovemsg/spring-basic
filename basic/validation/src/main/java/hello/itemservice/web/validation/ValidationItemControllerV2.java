...
//            errors.put("price", "");
            bindingResult.addError(new FieldError("item", "price", "가격은 1,000 ~ 100,000,000까지 허용합니다. "));
        }
...
//                errors.put("globalError", "가격 * 수량의 합은 10,000이상어야 합니다. 현재 값 = " + resultPrice);
                bindingResult.addError(new ObjectError("item", "가격 * 수량의 합은 10,000이상어야 합니다. 현재 값 = " + resultPrice));
            }
        }
