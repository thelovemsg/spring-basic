package hello.part14.composition;

import hello.part14.composition.policy.Phone;
import hello.part14.composition.policy.impimentation.NightlyDiscountPolicy;
import hello.part14.composition.policy.impimentation.RateDiscountablePolicy;
import hello.part14.composition.policy.impimentation.RegularPolicy;
import hello.part14.composition.policy.impimentation.TaxablePolicy;
